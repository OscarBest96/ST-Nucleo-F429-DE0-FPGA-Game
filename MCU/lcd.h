...
void initLCD(void);
void HIGH_SCORE (int a, int b, int c);
void POINTS (int x, int y, int z, int LEVEL, int i, int LED);
void GAME_OVER (void);
void Target_LED_1_LCD(void);
void Target_LED_2_LCD(void);
void Target_LED_3_LCD(void);
void progression_line(unsigned short i);
